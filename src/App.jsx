    ...
    return (
        <div id="Login">
            ...
            <div id="LoginTwo-right">
                ...
                <div className="btn">
                    <Button className="custom-btn1" text="Ingresar-admin" onClick={enterAdmin}></Button>
                </div>
                <div className="btn">
                    <Button className="custom-btn2" text="Ingresar-employees" onClick={enterEmployees}></Button>
                </div>
